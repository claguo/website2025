    ...
    <ContentWrapper className="bg-[#FFE4D5]">
      <div className="flex flex-col gap-[0.5rem] items-center">
        ...
        <p className="text-center lg:px-[6rem]">
          The Project Fair is a decentralized event: we built five free-standing
          boards to that display projects submitted by students. These boards
          were then distributed to five different locations around RISD and
          Brown campus as a way to advertise ongoing projects and new developing
          ideas.
        </p>
        <p className="font-mono text-xs">
          Sunday, April 30, 4PM @ 20 Washington Place Lobby
        </p>
      </div>
      ...
      >
        <div className="flex justify-between">
          <img
            src={poster}
            className="w-[49%]"
            alt="Project Fair advertising poster"
          />
          <img
            src={boarddesign}
            className="w-[49%]"
            alt="Project Fair board poster"
          />
        </div>
      </Content>
      <div className="w-[100%]">
        <h3 className="text-sm lg:text-base font-bold mb-[1rem] font-sans">
          Collab boards around campus.
        </h3>
        <div className="flex gap-[0.5rem] lg:justify-between w-[100%]">
          <figure className="flex-1">
            <img
              src={bdw}
              alt="Project fair set up at Brown Design Workshop."
            />
          ...
          <figure className="flex-1">
            <img
              src={cs}
              alt="Project fair set up at Brown Computer Science Building."
            />
            <p className="bg-[#FB7A52] p-[0.5rem]">
              Brown Computer Science Building
            </p>
          </figure>
          <figure className="flex-1">
