...
function ImpactCard(props) {
  ...
  return (
    <div
      ...
      className={`flex flex-col text-center ${isOpen ? '' : isHovered ? 'bg-gray' : 'bg-bg-body'} ${isHovered ? 'cursor-pointer' : ''}`}
    >
      {isHovered
      ? <div className="relative">
        <img src={props.src} alt={props.caption} className="brightness-[0.5]"/>
