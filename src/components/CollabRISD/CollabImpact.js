      ...
      <div className="flex flex-col lg:flex-row gap-[8rem]">
        <div className="flex flex-col gap-[6rem] flex-1">
          <ImpactCard
            ...
            src={[taxidermy]}
            caption={[
              "Here, Taxidermy Club is recruiting members at their first RISD Club Fair.",
            ]}
          />
          <ImpactCard
            color="bg-[#D1E84D]"
            ...
            src={[jenny]}
            caption={[
              "This is Jenny's toy design project on our Notion page, in the ideation phase.",
            ]}
          />
          <ImpactCard
            color="bg-[#FC7247]"
        ...
        <div className="flex flex-col gap-[6rem] justify-center flex-1">
          <ImpactCard
            ...
            src={[earthling]}
            caption={[
              "Yuqing and collaborators touring the Earthing Lab! This group included both Brown and RISD students and grad and undergrad students, in varying majors, but with a common interest in sustainability research.",
            ]}
          />
          <ImpactCard
            color="bg-[#FC7247]"
            ...
            src={[collab]}
            caption={[
              "Our own Notion project page, where we recruited collaborators!",
            ]}
          />
        </div>
      </div>
