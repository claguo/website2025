      ...
      >
        <figure className="mt-[1rem]">
          <div className="flex items-baseline gap-[0.5rem] font-bold">
            ...
            <p>A series of three local events to facilitate connection and collaboration.</p>
          </div>
          <img src={roundtable} alt="The Roundtable event: a presenter presenting to an audience of 18 people."/>
        </figure>
        <figure className="mt-[1rem]">
          <div className="flex items-baseline gap-[0.5rem] font-bold">
            <h3 className="font-mono">2.</h3>
            <p>A digital archive as a platform for gloabl outreach and information sharing.</p>
          </div>
          <img src={notion} alt="Screenshot of our Notion archive with a fun, illustrated banner, a link to project submission, and links to resources." />
        </figure>
      </Content>
    </ContentWrapper>
  )
