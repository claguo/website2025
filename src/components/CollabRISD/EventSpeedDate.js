    ...
    <ContentWrapper className="bg-[#FAFFE0]">
      <div className="flex flex-col gap-[0.5rem] items-center">
        ...
        <p className="text-center lg:px-[6rem]">
          A fun, casual meetup for students to find collaborators or brainstorm
          new ideas!
        </p>
        <p className="font-mono text-xs">
          Sunday, April 16, 4PM @ Upper Quad MET Room B
        </p>
      </div>
      <div className="flex flex-col lg:flex-row gap-[1rem]">
        ...
        <figure>
          ...
          />
          <p className="bg-[#D1E84D] p-[0.5rem]">
            Collaborative brainstoming session.
          </p>
        </figure>
        <figure>
          <img
          ...
          />
          <p className="bg-[#D1E84D] p-[0.5rem]">
            Pair up, exchange ideas, and rotate!
          </p>
        </figure>
      </div>
      <Content
