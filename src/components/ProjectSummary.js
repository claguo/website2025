  ...
  return (
    <div className="flex gap-xs lg:text-sm lg:text-sm lg:justify-between lg:gap-[3rem] text-xs lg:text-sm">
      <div className="flex flex-col gap-3xs lg:gap-xs flex-1">
        <span className="font-mono text-text-subtle text-sm"> Category </span>
        <p> {project.category} </p>
      </div>

      <div className="flex flex-col gap-3xs lg:gap-xs flex-1">
        <span className="font-mono text-text-subtle text-sm"> Team </span>
        <p> {project.team} </p>
      </div>

      <div className="flex flex-col gap-3xs lg:gap-xs flex-1">
        <span className="font-mono text-text-subtle text-sm"> Duration </span>
