...
function ReproResearch() {
  return (
    <Section tagText="Research" project="rcw">
      <div className="flex flex-col gap-xs">
        <Card>
          <span className="font-mono italic text-text-subtle">Insight 1</span>
          <TextStack
            header="A lack of social support causes feelings of guilt and shame in women."
            className="text-text-rcw font-medium"
          >
            <p>
        ...
        <Card>
          <span className="font-mono italic text-text-subtle">Insight 2</span>
          <TextStack
            header="Social and environmental determinants affect health outcomes."
            className="text-text-rcw font-medium"
          >
            <p>
        ...
        <Card>
          <span className="font-mono italic text-text-subtle">Insight 3</span>
          <TextStack
            header="Logistical difficulties involved getting an abortion cause stress that result in negative mental health outcomes."
            className="text-text-rcw font-medium"
          >
            <p>
